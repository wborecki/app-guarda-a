  ...
  return (
    <div ref={ref} className={`relative ${className}`}>
      ...
      {open && filtered.length > 0 && (
        <div className="absolute left-0 top-full mt-1.5 z-[100] bg-card border border-border rounded-xl shadow-2xl shadow-foreground/[0.14] overflow-hidden max-h-[280px] overflow-y-auto w-[260px] ring-1 ring-foreground/[0.04] backdrop-blur-sm">
          {!query.trim() && (
