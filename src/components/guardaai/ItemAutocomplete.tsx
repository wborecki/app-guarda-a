  ...
  return (
    <div ref={ref} className={`relative ${className}`}>
      ...
      {open && filtered.length > 0 && (
        <div className="absolute left-0 top-full mt-1.5 z-[100] bg-popover border border-border rounded-xl shadow-xl shadow-foreground/[0.08] overflow-hidden max-h-[280px] overflow-y-auto w-[260px]">
          {!query.trim() && (
